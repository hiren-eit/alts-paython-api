...
from src.domain.dtos.file_configuration_dto import FileConfiguration as FileConfigurationDTO
...
class UpdateDocumentConfiguration:
    ...
    def update_configuration(self, configuration: FileConfigurationDTO, updated_by: str) -> None:
        """
