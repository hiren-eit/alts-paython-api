...
class FileManagerRepository(IFileManagerRepository):
    ...
    def get_manual_extraction_config_fields_by_id(
        ...
        try:
            ...
            # C#: _appDbContext.DocumentConfigurations.Where(x => x.Id == documentConfigurationId && x.IsActive == true).FirstOrDefaultAsync();
            ...
            # C#: _appDbContext.DocumentConfigurationFields.Where(x => x.DocumentConfigurationId == documentConfigurationId && x.IsActive == true && x.DataType == DataTypes.Object).ToListAsync();
    ...
    def update_extract_document_api(
        ...
        """
        try:
            # from src.domain.dtos.update_extract_document_dto import ResponseObjectModel
            ...
            return ResponseObjectModel(
                resultcode="SUCCESS",
                resultmessage="Update Document save successful (Skeleton)"
            )
        except Exception as ex:
