...
class FileManagerRepository(IFileManagerRepository):
    ...
    def get_manual_extraction_config_fields_by_id(
        ...
        try:
            ...
            # C#: _appDbContext.FileConfigurations.Where(x => x.Id == fileConfigurationId && x.IsActive == true).FirstOrDefaultAsync();
            ...
            # C#: _appDbContext.FileConfigurationFields.Where(x => x.FileConfigurationId == fileConfigurationId && x.IsActive == true && x.DataType == DataTypes.Object).ToListAsync();
    ...
    def get_extract_file_api(
        ...
        try:
            ...
            # C#: await _appDbContext.ExtractionFileDetail.FirstOrDefaultAsync(x => x.FileUID == fileuid && x.IsActive == true)
    ...
    def update_extract_file_api(
        ...
        try:
            ...
            return ResponseObjectModel(
                resultcode="SUCCESS",
                resultmessage="Update File save successful (Skeleton)"
            )
        except Exception as ex:
