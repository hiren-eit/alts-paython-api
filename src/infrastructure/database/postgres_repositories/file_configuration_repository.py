...
from src.domain.dtos.document_configuration_dto import DocumentConfiguration, DocumentConfigurationField
...
class FileConfigurationRepository(IFileConfigurationRepository):
    ...
    async def save_file_configuration(self, db: Session, documentConfiguration: DocumentConfiguration) -> bool:
        """
    ...
    async def update_file_configuration(self, db: Session, documentConfiguration: DocumentConfiguration) -> bool:
        """
    ...
    async def update_file_action_configuration(self, db: Session, documentConfiguration: DocumentConfiguration) -> bool:
        """
    ...
    def _add_sub_rows_recursive(
        self,
        field_dto: DocumentConfigurationField,
